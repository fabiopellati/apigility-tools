    ...
    implements SqlActuatorListenerInterface, EventManagerAwareInterface
{
    ...
    public function attach(EventManagerInterface $events, $priority = 1000)
    {
        ...
        $this->listeners[] = $events->attach(SqlActuatorMapper::EVENT_MAPPER_CREATE, [$this, 'onMapperEvent'],
                                             $priority);
    ...
    public function onMapperEvent(EventInterface $e)
    {
        ...
        $event->getRequest()->getParameters()->set('mapper_action', SqlActuatorMapper::EVENT_MAPPER_CREATE);
